...
import com.edu.qa.util.WebEventListener;
...
public class TestBase {
	...
	public TestBase(){
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+ "/src/main/java/com/edu"
